...
import { preload } from "../../utilis/global-preload.ts";
...
const AdminSideBar = () => {
  ...
  { 
    sectionName: "Products Management", 
    path: "/admin",
    importFn: () => import("../../Compenets/Admin/Managements/AdminProductsManagement")
  },
  { 
    sectionName: "Orders Management", 
    path: "/admin/allOrders",
    importFn: () => import("./Managements/AdminOrdersManagement.tsx")
  },
  { 
    sectionName: "Brands Management", 
    path: "/admin/brands",
    importFn: () => import("../../Compenets/Admin/Managements/AdminBrandsManagement")
  },
  { 
    sectionName: "Categories Management", 
    path: "/admin/categories",
    importFn: () => import("../../Compenets/Admin/Managements/AdminCatManagement")
  },
  { 
    sectionName: "Subcategories Management", 
    path: "/admin/subCategories",
    importFn: () => import("../../Compenets/Admin/Managements/AdminSubCategoryManagement")
  },
 
  { 
    sectionName: "Add Product", 
    path: "/admin/addProduct",
    importFn: () => import("../../Compenets/Admin/Add/AddProductSection")
  },
  { 
    sectionName: "Coupons Management", 
    path: "/admin/coupons",
    importFn: () => import("./Managements/AdminCouponsManagement.tsx")
  },
];
  ...
  const DesktopSidebar = (
    <motion.nav
      className="hidden sm:block bg-white shadow-lg w-65  overflow-y-auto rounded-2xl font-roobert sticky top-0"
