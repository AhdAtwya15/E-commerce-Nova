...
import type {  IForgotPass } from "../../Interfaces";
import { useForgotPassMutation } from "../../app/Features/authenticationApi";
...
const ForgotPassPage = () => {
    ...
    const onSubmit: SubmitHandler<IForgotPass> = async (values) => {
